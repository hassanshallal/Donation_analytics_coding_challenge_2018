...
public:
    ...
    //This is the lead method of the class
    bool analyze(const string inputPercentile, const string inputRecords, const string outputName);
...
bool PipelineController::analyze(const string inputPercentile, const string inputRecords, const string outputName) {
